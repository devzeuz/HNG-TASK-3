  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center sm:space-x-5 md:space-x-16 mt-10 mb-20">
        <p>
          <img src="/src/asset/image/CaretLineLeft.png" alt="" />
        </p>
        <p>
          <img src="/src/asset/image/CaretLeft.png" alt="" />
        </p>
        <p className="text-3xl">1</p>
        <p className="text-3xl">2</p>
        <p className="text-3xl">3</p>
        <p>
          <img src="/src/asset/image/CaretRight.png" alt="" />
        </p>
        <p>
          <img src="/src/asset/image/CaretLineRight.png" alt="" />
        </p>
      </div>
    </>
  );
