    ...
    <>
      <div>
        <div className="flex justify-center flex-col ml-5 mr-5 items-center">
          <img src="/image/headerimage.png" alt="" className="md:hidden" />
          {/* FIRST BODY HEADER */}
          <div className="md:flex flex-col justify-center items-center space-y-5 mt-5 sm:hidden">
            <div className="flex space-x-5 ">
              ...
              <div>
                <img src="/image/Group 2.jpg" alt="" className="w-52" />
              </div>

              {/* SEARCH */}
              <div className="flex items-center bg-[#E2ECF1] p-2 rounded-full">
                <img src="/image/search (1).png" alt="" className="w-5" />
              ...
              <div className="">
                <img src="/image/Group 1.jpg" alt="" className="w-52" />
              </div>
            </div>

            <div>
              <img src="/image/RunDown.jpg" alt="" />
            </div>

            {/* THREE LINES */}
            <div>
              <img src="/image/Frame 36.jpg" alt="" />
            </div>
          </div>
          ...
          <div className=" justify-between space-x-5 sm:hidden md:flex mx-auto mt-10">
            <div className="space-y-5">
              <div className="border border-dashed border-black">
                <img src="/image/HeroSmall1.jpg" alt="" />
              </div>
              <img src="/image/HeroSmall3.jpg" alt="" />
              <img src="/image/HeroSmall2.jpg" alt="" />
            </div>

            {/* BIG SHIRT */}
            <div className="border border-solid p-1 border-black flex-0">
              <img src="/image/HeroLarge.jpg" alt="" />
            </div>
          ...
          <div>
            ...
            <div className="bg-[#E2ECF1] p-5 rounded-lg md:hidden">
              <img src="/image/firstbodyimage.jpg" alt="" />
